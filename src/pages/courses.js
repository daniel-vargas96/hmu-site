...
export default function Courses() {
  ...
  return (
    <>
      <div className='container courses justify-content-center text-center'>
        <h1>Courses</h1>
        <div className='hero d-flex justify-content-center'></div>
        <div className='row d-flex justify-content-center'>
          <div className='content col-lg-5 justify-content-center'>
        ...
        <div className='row d-flex justify-content-center'>
          ...
          <div className='content col-lg-5 justify-content-center text-left'>
